                        ...
                        <div class="col-lg-6 offset-lg-3">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title"> <i class="bi bi-plus-circle me-2"></i> Add video</h4>
                                    ...
                                    <form method="post" enctype="multipart/form-data" class="mt-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="title" required class="form-control" placeholder="Enter product name">
                                        </div>
                                           <div class="mb-3">
                                            <label class="form-label"><i class="bi bi-card-text me-1"></i>Add Link</label>
                                            <input type="text" name="link" required class="form-control" placeholder="Enter product name">
                                        </div>
