        ...
        <div class="page-content-wrapper">
            <div class="page-content">
                ...
                <div class="container mt-5">
                        ...
                        <div class="col-lg-10 offset-lg-1">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <a href="add-photo.php" class="btn btn-primary mb-3"><i class="bi bi-plus-circle me-1"></i>Add New</a>
                    ...
                    <td>₹{$row['price']}</td>
                    <td>
                        <a href='photo-edit.php?id={$row['id']}' class='btn btn-warning btn-sm'><i class='bi bi-pencil-square'></i></a>
                        <a href='delete-photo.php?id={$row['id']}' class='btn btn-danger btn-sm' onclick='return confirm(\"Delete this Photo?\")'><i class='bi bi-trash'></i></a>
                    </td>
                </tr>";
                                                }
                                                ?>
